...
// -----------------------------------------------------------------
// import logger from './logger/index.js'   // import cái module export default
import {logger2} from './logger/index.js'   // import cái module export đã được sửa tên ở file index.js

// console.log(logger)
// logger('Looix roi', constant.TYPE_LOG)

console.log(logger2)
logger2('Looix roi bạn ơi', constant.TYPE_WARN)
// ===================================================
// // Cách viết 1:
// import {   
//     TYPE_LOG,
